...
//       {showcard.map((item) => (
//         <div key={item.id} className='flex justify-center mx-auto pb-10'>
...
//                   src={imgSrc}
//                   alt={`${item.name} ${index}`}
//                   onMouseEnter={() => handleMouseEnter(imgSrc)} // Show zoom on hover
//                   onMouseLeave={handleMouseLeave} // Hide zoom when leaving
//                   onMouseMove={handleMouseMove} // Update zoom position
//                 />
//               ))}
//             </div>
...
//                 backgroundSize: isZoomed ? '200%' : '100%', // Zoom level
...
//                 alt={item.name}
//                 className="w-full h-full opacity-0" // Hide the original image but keep it for structure
//               />
//             </div>
//           </div>

//           <div className='w-1/2'>
//             <h1 className="text-3xl font-bold mb-4">Comfortable Product</h1>
